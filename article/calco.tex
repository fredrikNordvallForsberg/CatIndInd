...
every inductive-inductive definition can be %straightforwardly
...
We call a type expression \emph{strictly positive} in $X$ if $X$ never appears in the domain of a $\Pi$-type. It is a requirement for inductive definitions in predicative Type Theory that the inductively defined types appear only strictly positive in the type of the constructors, or equivalently, that the signature functor is given by a strictly positive expression.
